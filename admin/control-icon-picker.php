...
if( !function_exists('bizplan_icon_add_icon_picker_control') ) :
	function bizplan_icon_add_icon_picker_control( $wp_customize ) {
		class BizPlan_Icon_Customizer_Icon_Picker_Control extends WP_Customize_Control {
...
add_action( 'customize_register', 'bizplan_icon_add_icon_picker_control' );
