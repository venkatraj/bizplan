...
BizPlan WordPress Theme, Copyright (C) 2017, N. Venkat Raj
...
= Installation =
1. Download and unzip `bizplan` theme
2. Upload the `bizplan` folder to the `/wp-content/themes/` directory
...
BizPlan WordPress Theme bundles the following third-party resources:
== Resources ==
