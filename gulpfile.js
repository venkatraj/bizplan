...
gulp.task( 'translate', function () {   
     return gulp.src( './**/*.php')
       ...
       .pipe(wpPot( {
           domain        : 'bizplan',
           destFile      : 'bizplan.pot',
           package       : 'BizPlan'
       } ))
      .pipe(gulp.dest('languages/bizplan.pot'))
});  
...
gulp.task('clean', function() {
  return del(['images','languages/bizplan.pot','rtl.css']);      
}); 
...
gulp.task('watch',function(){  
  browserSync.init({  
    files: ['./**/*.php'],    
    proxy: 'http://localhost/new/bizplan',
  }); 
